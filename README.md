...
![Context Menu](./Graphics/Screenshots/Step1.png)

In the Options window, click **Create...**

![Options](./Graphics/Screenshots/Step2.png)

Select the keyboard layouts you want for this profile

![New Profile](./Graphics/Screenshots/Step3.png)

Once the profile is created, switch to it from the tray menu

![Switch Profile](./Graphics/Screenshots/Step4.png)
